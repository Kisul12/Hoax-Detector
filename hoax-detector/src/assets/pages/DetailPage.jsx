      ...
      <div className="pl-72 pt-14 pr-16 pb-8 bg-gray-100 min-h-screen">
        ...
        <div className="bg-white rounded-lg shadow-md p-8 max-w-4xl mx-auto">
          ...
          {detailData.type === 'video' && detailData.videoId ? (
            ...
            <div className="relative w-full max-w-lg mx-auto mb-6" style={{ paddingBottom: '56.25%' /* 16:9 Aspect Ratio */ }}>
              <iframe
                className="absolute top-0 left-0 w-full h-full rounded-lg"
                src={`https://www.youtube.com/embed/${detailData.videoId}?autoplay=0`} // Pastikan format URL YouTube embed benar
                frameBorder="0"
            ...
            // Tampilan untuk Overview CSV/Excel (jika ingin ditampilkan di detail juga)
                ...
                <div className="overflow-x-auto border border-gray-200 rounded-lg">
                  <table className="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      {/* Pastikan ini menampilkan previewRows dengan benar */}
            ...
            // Fallback jika tidak ada video/csv (misal: hanya teks murni)
            <div className="w-full text-center mb-6">
                   <img
                      src="/people.png"
                      alt="Tidak ada media preview"
            ...
            <div className="grid grid-cols-3 gap-x-4 items-center">
              ...
              <div className="col-span-2 flex items-center gap-2">
                ...
                {detailData.illustration && (
                  <img
                    src={detailData.illustration}
                    alt={detailData.status}
                    className="w-8 h-8"
                  />
                )}
              </div>
